...
public class DistanceBars : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        distanceTillGoalForP1 = Vector3.Distance(player1.transform.position, endGoal.transform.position) - .9f;
        distanceTillGoalForP2 = Vector3.Distance(player2.transform.position, endGoal.transform.position) - .9f;
